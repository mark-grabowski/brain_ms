---
title: "SB R2 BDS ms Intercept Plots - Platyrrhines"
...
load("/Users/markgrabowski/Documents/Academic/Research/Current Projects/Brain Size Diet + Social System/SB Revision 2/Results/SIMMAPS 062522 v1/SIMMAP ACE/Platyrrhines/SBR2 - WS from SIMMAP ACE - Platyrrhines - Scaled 062522.RData")
```
...
ms.plot<-ggplot(data=BoM.category.means,aes(x=Categories,y=pred.ECV))+
  ...
  geom_point(data=BoM.category.means,mapping=aes(fill=Categories,shape=Categories),size=5,color="white")+ggtitle("Platyrrhines")
