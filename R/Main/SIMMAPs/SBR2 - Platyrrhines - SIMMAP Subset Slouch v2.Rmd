---
title: "SBR2 - BDS ms Platyrrhine Analysis for SIMMAPs Plot Code - 062722"
...
Save workspace
```{r}
save.image("WS from SIMMAP - Platyrrhines - Scaled 062722.RData")
...
write.csv(simmap.summary.table,"SBR2_SIMMAP_Platyrrhines_Scaled_Discrete_Summary_Table_062722.csv",row.names = FALSE)

simmap.AIC.table<-make.slouch.simmap.AIC.table(saved.slouch.output.list,loops.num*sim.num)
write.csv(simmap.AIC.table,"SBR2_SIMMAP_Platyrrhines_Scaled_Discrete_AIC_Table_062722.csv",row.names = FALSE)
...
```{r}
write.table(slouch.output,"SBR2_SIMMAP_Platyrrhines_Scaled_Cont_Table_062722.csv",sep=",",row.names=FALSE)
write.table(slouch.table,"SBR2_SIMMAP_Platyrrhines_Scaled_Cont_AIC_Table_062722.csv",sep=",",row.names=FALSE)
```
